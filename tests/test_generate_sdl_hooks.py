...
class GeneratedSdlHooksTest(unittest.TestCase):
    def test_checked_hook_set(self) -> None:
        ...
        self.assertIn("SDL_CreateRGBSurface", symbols)
        self.assertIn("SDL_CreateRGBSurfaceFrom", symbols)
        self.assertIn("SDL_CreateRGBSurfaceWithFormat", symbols)
        self.assertIn("SDL_CreateRGBSurfaceWithFormatFrom", symbols)
        self.assertIn("SDL_SetColorKey", symbols)
        self.assertIn("SDL_ConvertSurface", symbols)
        self.assertIn("SDL_ConvertSurfaceFormat", symbols)
        self.assertIn("SDL_FillRect", symbols)
        self.assertIn("SDL_FillRects", symbols)
